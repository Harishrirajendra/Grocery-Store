...
with app.app_context():
    ...
    class CategoryListResource(Resource):
        ...
        def delete(self, category_id):
            ...
            # You might want to handle the deletion of associated products here
    ...
    class ProductListResource(Resource):
        ...
        def post(self):
            ...
            parser.add_argument('mnfDate', type=str, required=True, help='Manufacturing date of the product')
            parser.add_argument('price', type=float, required=True, help='Price of the product')
            parser.add_argument('stock', type=int, required=True, help='Stock of the product')
            parser.add_argument('category_id', type=int, required=True, help='Category ID of the product')
            args = parser.parse_args()

            product = Product(
                name=args['name'],
                mnfDate=args['mnfDate'],
                price=args['price'],
                stock=args['stock'],
...
# Custom user loader function for Flask-Login
@login_manager.user_loader
def load_user(user_id):
    return User.query.get(int(user_id))
